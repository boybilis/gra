...
<head>
  ...
  <?php require_once __DIR__ . '/course-hero-library.php'; $courseHero = get_course_hero_image('sple'); ?>
  <meta charset="utf-8">
...
<body class="index-page gra-page">
  ...
  <main class="main">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 position-relative align-self-start" data-aos="fade-up" data-aos-delay="100">
            <img src="<?php echo htmlspecialchars($courseHero['image_url'], ENT_QUOTES, 'UTF-8'); ?>" class="img-fluid" alt="SPLE review course">
          </div>
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <h3>Prepare for professional licensure while overseas.</h3>
            <p class="fst-italic">GRA's SPLE PassEasy<sup class="gra-trademark">&trade;</sup> course combines expert instruction, flexible learning access, practice support, and review guidance for students preparing for exam day.</p>
            <ul>
    ...
    <?php
      $courseSchedule = get_course_schedule_image('sple');
    ...
    <section id="course-passers" class="featured-passers course-passers section light-background">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="swiper init-swiper featured-passers-swiper" data-course="sple" data-initial-limit="8" data-next-limit="4">
