  ...
  <main class="main">
    ...
    <section id="course-overview" class="about section light-background">
      <div class="container section-title" data-aos="fade-up">
        <h2>DHA - RN</h2>
        <p>Dubai Health Authority review preparation for nurses pursuing DHA licensing.</p>
      </div>
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 position-relative align-self-start" data-aos="fade-up" data-aos-delay="100">
            <img src="assets/img/gra/dha-course.jpg" class="img-fluid" alt="DHA - RN review course">
          </div>
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <h3>Prepare for the DHA licensing exam with expert support.</h3>
            <p class="fst-italic">GRA's DHA PassEasy course combines expert instruction, flexible learning access, practice support, and review guidance for students preparing for exam day.</p>
            <ul>
    ...
    <section id="course-passers" class="featured-passers course-passers section light-background">
      <div class="container section-title" data-aos="fade-up">
        <h2>DHA Passer Stories</h2>
        <p>Successful DHA passers from the GRA community.</p>
      </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <article class="featured-passer-card">
                <a href="<?php echo $passerUrl; ?>" class="glightbox" data-gallery="dha-passers" data-title="<?php echo $passerAlt; ?>">
    ...
    <section id="course-package" class="services section">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100"><div class="service-item position-relative"><div class="icon"><i class="fas fa-user-nurse"></i></div><h3>Program Access</h3><p>3 months review access with comprehensive lectures, review materials, and guided study direction.</p></div></div>
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="400"><div class="service-item position-relative"><div class="icon"><i class="fas fa-building"></i></div><h3>PassEasy DHA Track</h3><p>Focus on DHA exam patterns, recall strategy, and high-yield nursing concepts for licensing readiness.</p></div></div>
        </div>
      </div>
    </section>
