...
<head>
  ...
  <title>Prometric RN PassEasy Course | Gapuz Review Academy</title>
  ...
  <main class="main">
    ...
    <section id="course-overview" class="about section light-background">
      <div class="container section-title" data-aos="fade-up">
        <h2>Prometric - RN</h2>
        <p>Prometric examination preparation for registered nurses seeking licensure in GCC and related healthcare destinations.</p>
      </div>
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 position-relative align-self-start" data-aos="fade-up" data-aos-delay="100">
            <img src="assets/img/gra/prometric-course.jpg" class="img-fluid" alt="Prometric - RN review course">
          </div>
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <h3>Prepare for Prometric nursing licensure with confidence.</h3>
            <p class="fst-italic">GRA's Prometric PassEasy course combines expert instruction, flexible learning access, practice support, and review guidance for students preparing for exam day.</p>
            <ul>
    ...
    <section id="course-package" class="services section">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100"><div class="service-item position-relative"><div class="icon"><i class="fas fa-globe"></i></div><h3>Program Access</h3><p>3 months review access with comprehensive lectures, review materials, and guided study direction.</p></div></div>
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="400"><div class="service-item position-relative"><div class="icon"><i class="fas fa-earth-asia"></i></div><h3>PassEasy Prometric Track</h3><p>Strengthen Prometric exam readiness with GCC-aligned practice focus, pacing strategy, and concept review.</p></div></div>
        </div>
      </div>
    </section>
    ...
    <section id="course-details" class="features section light-background">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Testmasters</h2>
        <p>Lead Testmasters for Prometric-RN preparation.</p>
      </div>
      <div class="container">
        <div class="row gy-4">
