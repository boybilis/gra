...
<head>
  ...
  <?php require_once __DIR__ . '/course-hero-library.php'; $courseHero = get_course_hero_image('prometric'); ?>
  <meta charset="utf-8">
...
<body class="index-page gra-page">
  ...
  <main class="main">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 position-relative align-self-start" data-aos="fade-up" data-aos-delay="100">
            <img src="<?php echo htmlspecialchars($courseHero['image_url'], ENT_QUOTES, 'UTF-8'); ?>" class="img-fluid" alt="Prometric - RN review course">
          </div>
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <h3>Prepare for Prometric nursing licensure with confidence.</h3>
            <p class="fst-italic">GRA's Prometric PassEasy<sup class="gra-trademark">&trade;</sup> course combines expert instruction, flexible learning access, practice support, and review guidance for students preparing for exam day.</p>
            <ul>
    ...
    <?php
      $courseSchedule = get_course_schedule_image('prometric');
            ...
            <div class="row">
              <div class="col-6" data-aos="fade-up" data-aos-delay="100">
                <div class="service-item position-relative h-100">
                  ...
                  <p>Our flagship Prometric review program.</p>
