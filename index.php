  ...
  <header id="header" class="header sticky-top">
    ...
    <div class="branding d-flex align-items-center">
      <div class="container position-relative d-flex align-items-center justify-content-end">
        ...
        <a class="cta-btn" href="#enroll">Inquire Now</a>
      </div>
    </div>
  </header>
    ...
    <section id="testimonials" class="testimonials section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="swiper init-swiper">
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide"><div class="testimonial-item"><p><i class="bi bi-quote quote-icon-left"></i><span>Stop doubting yourself, work hard, and make it happen. I mostly used Artemis360 recordings and practice tests, and the NGN questions were very similar to the actual exam. Gapuz prepared me well, especially the intensive final coaching.</span><i class="bi bi-quote quote-icon-right"></i></p><img src="assets/img/gra/passers/amira-quilapio.jpg" class="testimonial-img" alt="Amira Fatmah P. Quilapio"><h3>Amira Fatmah P. Quilapio, RN, Nurse Specialist, USRN</h3><h4>NEXT GEN NCLEX-RN Passer, New York</h4></div></div>
            <div class="swiper-slide"><div class="testimonial-item"><p><i class="bi bi-quote quote-icon-left"></i><span>After a decade, I finally took NCLEX-RN. Through Artemis360 and intensive review, my exam shut down at 85 and I passed on my first attempt. The strategies from the Testmasters made every concept easier to understand.</span><i class="bi bi-quote quote-icon-right"></i></p><img src="assets/img/gra/passers/frendchie-arenas.jpg" class="testimonial-img" alt="Frendchie Kei Arenas"><h3>Frendchie Kei Arenas, USRN</h3><h4>NEXT GEN NCLEX-RN Passer, New Mexico</h4></div></div>
            <div class="swiper-slide"><div class="testimonial-item"><p><i class="bi bi-quote quote-icon-left"></i><span>I had barely practiced nursing for years, but Gapuz helped me rebuild confidence. Artemis360 videos, mock tests, and focused lectures played a big role in my success.</span><i class="bi bi-quote quote-icon-right"></i></p><img src="assets/img/gra/passers/kieth-laguit.jpg" class="testimonial-img" alt="Kieth Michael Ray Laguit"><h3>Kieth Michael Ray Laguit, USRN</h3><h4>NEXT GEN NCLEX-RN Passer, Illinois</h4></div></div>
            <div class="swiper-slide"><div class="testimonial-item"><p><i class="bi bi-quote quote-icon-left"></i><span>After 15 years post-grad, I braved the NCLEX and went 85 and out. I am forever grateful to the Gapuz team and Testmasters for the strategies and test-taking sessions through Artemis360.</span><i class="bi bi-quote quote-icon-right"></i></p><img src="assets/img/gra/passers/bernadette-pangilinan.jpg" class="testimonial-img" alt="Bernadette Anne Pangilinan"><h3>Bernadette Anne Pangilinan, AURN</h3><h4>NEXT GEN NCLEX-RN Passer, Australia</h4></div></div>
            <div class="swiper-slide"><div class="testimonial-item"><p><i class="bi bi-quote quote-icon-left"></i><span>Despite a hectic nursing schedule, my review remained stress-free. Gapuz gave me strong materials and sharpened my test-taking skills that helped me pass the Next Gen NCLEX.</span><i class="bi bi-quote quote-icon-right"></i></p><img src="assets/img/gra/passers/karen-atienza.jpg" class="testimonial-img" alt="Karen R. Atienza"><h3>Karen R. Atienza, USRN</h3><h4>NEXT GEN NCLEX-RN Passer, New York</h4></div></div>
            <div class="swiper-slide"><div class="testimonial-item"><p><i class="bi bi-quote quote-icon-left"></i><span>I joined QuickPass NGN with Artemis360 and I am now a USRN. Thank you to the Gapuz Review and Processing family for the guidance, encouragement, and support from start to exam day.</span><i class="bi bi-quote quote-icon-right"></i></p><img src="assets/img/gra/passers/carla-peralta.jpg" class="testimonial-img" alt="Carla Mae A. Peralta"><h3>Carla Mae A. Peralta, USRN</h3><h4>NEXT GEN NCLEX-RN Passer, New York</h4></div></div>
          </div>
          <div class="swiper-pagination"></div>
        </div>
      </div>
          ...
          <div class="col-lg-6">
            <div class="contact-detail-group" data-aos="fade-up" data-aos-delay="300">
              <div class="contact-mini-card">
                ...
                <div>
                  <h3>Call Us</h3>
                  <p>Mobile: +639292135296 / Landline: +63285599060</p>
                </div>
              </div>
              <div class="contact-mini-card">
