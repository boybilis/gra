  ...
  <main class="main">
    ...
    <section id="courses" class="services section light-background">
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100"><div class="service-item position-relative"><div class="icon"><i class="fas fa-stethoscope"></i></div><a href="nclex-rn-courses.php" class="stretched-link"><h3>NCLEX</h3></a><p>Next Generation NCLEX-RN test preparation for nurses pursuing nursing licensure for the U.S., Canada, Australia and others.</p></div></div>
          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200"><div class="service-item position-relative"><div class="icon"><i class="fas fa-user-nurse"></i></div><a href="dha-rn-courses.php" class="stretched-link"><h3>DHA</h3></a><p>Dubai Health Authority licensure exam test preparation for nurses pursuing DHA licensing in Dubai, UAE.</p></div></div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400"><div class="service-item position-relative"><div class="icon"><i class="fas fa-globe"></i></div><a href="prometric-rn-courses.php" class="stretched-link"><h3>Prometric</h3></a><p>Prometric licensure exam test preparation for nurses seeking professional licensure in Saudi Arabia, Qatar, Bahrain, Oman, and other GCC countries.</p></div></div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600"><div class="service-item position-relative"><div class="icon"><i class="fas fa-notes-medical"></i></div><a href="pnle-courses.php" class="stretched-link"><h3>PNLE</h3></a><p>Philippine Nurses Licensure Examination test preparation.</p></div></div>
          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="700"><div class="service-item position-relative"><div class="icon"><i class="fas fa-file-lines"></i></div><a href="civil-service-courses.php" class="stretched-link"><h3>Civil Service</h3></a><p>Philippine Civil Service Examination test preparation for professional and sub-professional government eligibility.</p></div></div>
          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="800"><div class="service-item position-relative"><div class="icon"><i class="fas fa-chalkboard-teacher"></i></div><a href="lept-courses.php" class="stretched-link"><h3>LEPT</h3></a><p>Philippine Licensure Exam for Professional Teachers Test Preparation (Elementary and Secondary).</p></div></div>
        </div>
      </div>
    </section>
