...
<head>
  ...
  <?php require_once __DIR__ . '/course-hero-library.php'; $courseHero = get_course_hero_image('pnle'); ?>
  <meta charset="utf-8">
...
<body class="index-page gra-page">
  ...
  <main class="main">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 position-relative align-self-start" data-aos="fade-up" data-aos-delay="100">
            <img src="<?php echo htmlspecialchars($courseHero['image_url'], ENT_QUOTES, 'UTF-8'); ?>" class="img-fluid" alt="PNLE review course">
          </div>
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <h3>Prepare for the Philippine Nursing Licensure Examination with a guided review plan.</h3>
            <p class="fst-italic">GRA's PNLE PassEasy<sup class="gra-trademark">&trade;</sup> course combines expert instruction, flexible learning access, practice support, and review guidance for students preparing for exam day.</p>
            <ul>
    ...
    <?php
      ...
      $coursePassers = get_latest_passer_images(16, 'pnle');
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="swiper init-swiper featured-passers-swiper" data-course="pnle" data-initial-limit="16" data-next-limit="8">
          ...
          <div class="passer-carousel-controls">
            <button type="button" class="swiper-button-prev pnle-passer-prev" aria-label="Show previous PNLE passers"></button>
            <div class="swiper-pagination"></div>
            <button type="button" class="swiper-button-next pnle-passer-next" aria-label="Show next PNLE passers"></button>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="course-package" class="services section">
      <div class="container section-title" data-aos="fade-up">
        ...
        <p>PNLE and SPLE promotional review packages.</p>
      </div>
      <div class="container">
            ...
            <div class="row g-4 pnle-review-options">
              <div class="col-6" data-aos="fade-up" data-aos-delay="100">
                <div class="service-item position-relative h-100 pnle-review-option-card">
                  <span class="pnle-review-option-badge">PNLE | SPLE</span>
