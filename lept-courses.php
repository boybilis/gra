...
<body class="index-page gra-page">
  ...
  <main class="main">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="inclusion-strip">
          ...
          <div>
            ...
            <p>Our program is designed to strengthen learning foundation and build confidence to pass the LEPT exam.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <?php
      $courseSchedule = get_course_schedule_image('lept');
    ...
    <section id="course-passers" class="featured-passers course-passers section light-background">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="swiper init-swiper featured-passers-swiper" data-course="lept" data-initial-limit="8" data-next-limit="4">
