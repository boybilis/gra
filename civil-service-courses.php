      ...
      <div class="container">
        <article class="cse-lead-profile" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="cse-lead-profile-content">
            ...
            <ul>
              <li><strong>Education:</strong><br>University of the Philippines – Manila<br>Asian Institute of Management (Makati, Philippines)<br>Instituto de Empresa (Madrid, Spain)<br>Web Technologies, Harvard (ongoing)</li>
