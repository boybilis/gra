...
<body class="index-page gra-page">
  ...
  <main class="main">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 position-relative align-self-start" data-aos="fade-up" data-aos-delay="100">
            <img src="assets/img/gra/civil-service-course.png" class="img-fluid" alt="Civil Service review course">
          </div>
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <h3>Prepare for Philippine Civil Service eligibility.</h3>
            <p class="fst-italic">GRA's Civil Service PassEasy course combines expert instruction, flexible learning access, practice support, and review guidance for students preparing for exam day.</p>
            <ul>
    ...
    <section id="course-package" class="services section">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100"><div class="service-item position-relative"><div class="icon"><i class="fas fa-file-lines"></i></div><h3>Program Access</h3><p>3 months review access with comprehensive lectures, review materials, and guided study direction.</p></div></div>
    ...
    <?php
      ...
      $coursePassers = get_latest_passer_images(8, 'civil-service');
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <article class="featured-passer-card">
                <a href="<?php echo $passerUrl; ?>" class="glightbox" data-gallery="civil-service-passers" data-title="<?php echo $passerAlt; ?>">
