...
<head>
  ...
  <title>DOH / HAAD RN PassEasy Course | Gapuz Review Academy</title>
  ...
  <main class="main">
    ...
    <section id="course-overview" class="about section light-background">
      <div class="container section-title" data-aos="fade-up">
        <h2>DOH / HAAD - RN</h2>
        <p>Department of Health Abu Dhabi licensure review preparation for nurses who want focused, flexible, and affordable support.</p>
      </div>
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 position-relative align-self-start" data-aos="fade-up" data-aos-delay="100">
            <img src="assets/img/gra/doh-haad-course.png" class="img-fluid" alt="DOH / HAAD - RN review course">
          </div>
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <h3>Prepare for Abu Dhabi nursing licensure with structure.</h3>
            <p class="fst-italic">GRA's HAAD (DOH) PassEasy course combines expert instruction, flexible learning access, practice support, and review guidance for students preparing for exam day.</p>
            <ul>
    ...
    <section id="course-passers" class="featured-passers course-passers section light-background">
      <div class="container section-title" data-aos="fade-up">
        ...
        <p>Successful HAAD / DOH passers from the GRA community.</p>
      </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <article class="featured-passer-card">
                <a href="<?php echo $passerUrl; ?>" class="glightbox" data-gallery="haad-doh-passers" data-title="<?php echo $passerAlt; ?>">
    ...
    <section id="course-package" class="services section">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100"><div class="service-item position-relative"><div class="icon"><i class="fas fa-hospital-user"></i></div><h3>Program Access</h3><p>3 months review access with comprehensive lectures, review materials, and guided study direction.</p></div></div>
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="400"><div class="service-item position-relative"><div class="icon"><i class="fas fa-hospital"></i></div><h3>PassEasy HAAD/DOH Track</h3><p>Train with HAAD/DOH-style question practice, exam strategy coaching, and structured study pacing.</p></div></div>
        </div>
      </div>
    </section>
    ...
    <section id="course-details" class="features section light-background">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Testmasters</h2>
        <p>Lead Testmasters for DOH / HAAD preparation.</p>
      </div>
      <div class="container">
        <div class="row gy-4">
